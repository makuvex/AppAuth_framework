...
PROJECT_TARGET_NAME="AppAuth_iOS"
...
xcodebuild -target "${PROJECT_TARGET_NAME}" -configuration "${CONFIGURATION}" -sdk "iphoneos" \
...
xcodebuild -target "${PROJECT_TARGET_NAME}" -configuration "${CONFIGURATION}" -sdk "iphonesimulator" \
